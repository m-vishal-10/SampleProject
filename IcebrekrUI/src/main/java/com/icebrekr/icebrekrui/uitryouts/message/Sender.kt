...
@Composable
fun Sender(sender: String,message: String,time:String,pfp: Painter){
...
@Composable
fun SenderPreview() {
    Sender("Bob (Moderator)",
        "Of course, Alice! I'll prepare some questions in advance. Charlie, do you have any specific topics you want covered?",
        "23:22 pm",
